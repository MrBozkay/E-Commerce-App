...
const Login = () => {
  ...
  const { login ,validateUser,user,googleLogin } =useShopContext()
     ...
     <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        ...
        <div className="mt-6  ">
          ...
          <button
          onClick={googleLogin}  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-input bg-background hover:bg-slate-100 hover:text-accent-foreground h-10 px-4 py-2 w-full" >
        ...
        <div className="mt-6">
          <p className="text-center text-sm text-gray-600">Login with social media</p>
